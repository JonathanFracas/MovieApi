...
```
java -Dspring.profiles.active=production -jar ./target/movie-api-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=tp/movie-api
```
